              ...
              >
                <div className="flex items-center gap-2 mb-3 flex-wrap">
                  ...
                  {currentQuestion?.isFollowUp && (
                    <span className="font-mono-studio inline-flex items-center gap-1 px-2 py-0.5 rounded-md bg-amber-100 dark:bg-amber-500/10 text-amber-800 dark:text-amber-300 border border-amber-300 dark:border-amber-500/30 text-[10px] tracking-wide">
